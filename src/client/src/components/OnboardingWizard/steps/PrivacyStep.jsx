...
function PrivacyStep({ selected, onSelect }) {
  return (
    <div className="p-4">
      {/* Header */}
      <div className="text-center mb-6">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Profile Privacy</h2>
      ...
      {/* Summary */}
      <div className="px-4 py-3 bg-dark-elevated/50 rounded-xl">
        {selected === 'PUBLIC' && (
